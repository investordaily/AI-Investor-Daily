...
const KEYWORDS = ['AI', 'artificial intelligence', 'machine learning', 'LLM', 'large language model', 'GPT', 'Claude', 'Copilot', 'chatbot', 'neural', 'deep learning', 'gpu', 'reinforcement learning', 'computer vision'. 'natural language processing', 'supervised learning', 'reinforcement learning'];
